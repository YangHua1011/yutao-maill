...
import com.ysir.yutao.common.constant.ProductConstant;
...
import com.ysir.yutao.product.feign.CouponFeignService;
import com.ysir.yutao.product.feign.SearchFeignService;
import com.ysir.yutao.product.feign.WareFeignService;
...
//        spuInfoEntity.setBrandName(brandEntity.getName());
    ...
    public void up(Long spuId) {
        ...
        try {
            ResponseResult skuHasStock = wareFeignService.getSkuHasStock(skuIdList);
            //
        ...
        ResponseResult r = searchFeignService.productStatusUp(collect);
